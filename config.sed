...
#
# Intel CPU
s/^(CONFIG_INTEL_IOMMU=.*|# CONFIG_INTEL_IOMMU is not set)/CONFIG_INTEL_IOMMU=y/;
# Include Intel GPU driver
s/^(CONFIG_DRM_I915=.*|# CONFIG_DRM_I915 is not set)/CONFIG_DRM_I915=y/;
# NVME
